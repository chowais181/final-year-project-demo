...
export default class ModalofAddExam extends Component {
  constructor(props) {
    super(props);
    this.state = {
      title: '',
        ...
        <Modal.Body>
          <div className="card">
            <div className="card-header card-header-primary">
              <h4 className="card-title">Add Exam</h4>
              <p className="card-category">Enter Exam Details</p>
            </div>
            <div className="card-body">
              <form onSubmit={this.handleSubmit}>
                ...
                <button type="submit" class="btn btn-primary pull-right">Add Exam</button>
