...
export default function UploadAssessmentByTeacher() {
    return (
        <div>     
        <div class="wrapper ">
            <TeacherSidebar />
        <div class="main-panel">
         <TeacherNavbar  name="Upload  Assessment"/>
                    ...
                    <div class="row">
                     ...
                     <select class="form-control ">
                        ...
                        <Link to="/teacherdashboard">
                          <button type="submit" class="btn btn-primary pull-right">Add Evaluation</button>
                    </Link>
